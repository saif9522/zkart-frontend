...
registerRoute(
  // Product photos: old local /media/ URLs and Supabase Storage public URLs
  ({ url }) => url.pathname.startsWith('/media/') || url.pathname.startsWith('/storage/v1/object/public/'),
  new CacheFirst({
