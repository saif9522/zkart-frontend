...
export interface ProductDetail {
  ...
  name: string
  slug: string
  /** Sanitized HTML or plain text — render with <ProductDescription>. */
  description: string
  /** Same content with all tags stripped (for SEO/meta/share). */
...
export interface OrderDetail extends Omit<OrderListItem, 'item_count'> {
  ...
  extra_charges_breakdown?: { code: string; label: string; amount: string }[]
  rating?: { shop_rating: number; delivery_rating: number | null; comment: string; created_at: string } | null
  coupon_code: string
