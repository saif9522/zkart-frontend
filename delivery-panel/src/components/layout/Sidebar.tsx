...
import { IndianRupee, LayoutDashboard, LogOut, ShoppingBag } from 'lucide-react'
    ...
    <aside className="w-60 shrink-0 bg-surface-900 flex flex-col h-screen sticky top-0">
      <div className="px-4 py-5 flex items-center gap-2.5 border-b border-surface-700">
        ...
        <div>
          ...
          <p className="text-xs text-rice-100/50 leading-tight">Delivery Partner</p>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-surface-700">
        <div className="px-3 mb-2">
          <p className="text-sm font-medium text-rice-50 truncate">{user?.full_name || 'Delivery Partner'}</p>
