        ...
        >
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={4}
              className="rounded-lg border border-ink-100 px-3 py-2 text-sm outline-none focus:border-forest-400 resize-y"
            />
            <span className="text-[11px] text-ink-300">
              Plain text is fine. You can also paste from Amazon/Flipkart — headings, lists and tables are kept,
              everything else (links, images, scripts, styling) is removed automatically.
            </span>
          </label>
